...
class PageCache
{
    ...
    public function __construct()
    {
        ...
        // sets $this->device to one of desktop, tablet, or mobile
    ...
    public function ServeFromCache()
    {
        ...
        $affectedGets = $this->getAffectedGets($_GET);
        ksort($affectedGets);
        $url = http_build_query($affectedGets);
    ...
    private function getAffectedGets($getParams)
    {
        $affectedGets = [];

        foreach ($getParams as $getParamName => $getParamValue) {
            if ($this->isAffectedGetParam($getParamName)) {
                $affectedGets[$getParamName] = $getParamValue;
            }
        }
    ...
    private function isAffectedGetParam($paramName)
    {
        $ignoredGetParamsRegExes = $this->skipGets;

        return !$this->isPregMatchSome($ignoredGetParamsRegExes, $paramName);
    }
     ...
     * @return bool
     */
    private function isPregMatchSome($regExes, $paramName)
    {
